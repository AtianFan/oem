...
(function ($) {
    ...
    $.fn.bdt = function (options, callback) {
        ...
        var settings = $.extend({
            ...
            pageRowCount: options.pageRowCount || 10,
            arrowDown: 'fa-angle-down',
            arrowUp: 'fa-angle-up',
			tableFooter: options.tableFooter,
        ...
        return this.each(function () {
			...
			tableFooter = settings.tableFooter;
