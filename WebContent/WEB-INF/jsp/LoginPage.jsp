...
<body>
	<form>
		<div id="loginForm">
			...
			<form:input on_focus="inputFocus()" on_blur="inputBlur();" name="loginName" title="用户名"/>
			<form:input on_focus="inputFocus()" on_blur="inputBlur();" name="password" type="password" title="密码"/>
