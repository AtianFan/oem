...
<link type="text/css" rel="stylesheet" href="<%=basePath%>css/page/homePage.css"/>
	...
	<header id="myCarousel" class="carousel slide">
		...
		<div class="carousel-inner">
			<div class="item active">
				<div class="fill" style="background-image: url('<%=basePath%>image/1.jpg');"></div>
		...
		<div class="row" id="recContentDiv" style="overflow:hidden;">
			 <!-- <div class="col-lg-12"> -->
                <h1 class="page-header">
                  	<img src="${basePath}newStyle/img/home_icon.png"/><form:i18n name="recomm"/>
                </h1>
            <!-- </div> -->
		</div>
