...
<head>
	...
	<link rel="stylesheet" href="<%=basePath%>css/page/orderReceivePage.css" media="screen" type="text/css" />
	...
	<script src="<%=basePath%>js/jquery.bdt.min.js" type="text/javascript"></script>
	<script src="<%=basePath%>js/page/orderReceivePage.js" type="text/javascript"></script>
	<title>接任务列表</title>
