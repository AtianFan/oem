...
<head>
	...
	<link rel="stylesheet" href="<%=basePath%>css/page/orderPage.css" media="screen" type="text/css" />
	...
	<script src="<%=basePath%>js/page/orderPage.js" type="text/javascript"></script>
	<title>任务列表</title>
</head>
<body>
	<div id="container">
